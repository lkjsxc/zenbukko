...
- `/data/downloads` contains course material, submitted confirmation-test
  answers exposed for review, and generated outputs.
...
Authenticated confirmation-test, material, and media headers are sent only to
validated NNN origins. Cookie and authorization headers are removed before
cross-origin asset, playlist, segment, or redirect requests. Material PDF
rendering disables JavaScript and network requests.
